...
template const Prediction AugmentedLinearizedSystem<
...
template const Prediction AugmentedLinearizedSystem<
    ParallelCompressors, ConstexprArray<0, 40, 0, 40>,
    4>::GenerateSubPrediction<3>(const int p, const int m,
                                 const int* output_index) const;

template void AugmentedLinearizedSystem<
    ParallelCompressors, ConstexprArray<0, 40, 0, 40>,
    4>::GenerateSubPrediction<2>(Eigen::MatrixXd* Su, Eigen::MatrixXd* Sx,
                                 Eigen::MatrixXd* Sf, const int p, const int m,
                                 const int* output_index) const;

template const Prediction AugmentedLinearizedSystem<
    ParallelCompressors, ConstexprArray<0, 40, 0, 40>,
    4>::GenerateSubPrediction<4>(const int p, const int m,
                                 const int* output_index) const;

template void AugmentedLinearizedSystem<
    ParallelCompressors, ConstexprArray<0, 40, 0, 40>,
    4>::GenerateSubPrediction<4>(Eigen::MatrixXd* Su, Eigen::MatrixXd* Sx,
                                 Eigen::MatrixXd* Sf, const int p, const int m,
                                 const int* output_index) const;
