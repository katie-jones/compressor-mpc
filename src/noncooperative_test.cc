...
int main(int argc, char **argv) {
  ...
  output_file.open("parallel/output/noncoop_output" + std::to_string(n_solver_iterations) +
                   ".dat");
  ...
  info_file.open("parallel/output/noncoop_info" + std::to_string(n_solver_iterations) + ".dat");
